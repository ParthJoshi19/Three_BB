...
const fragmentShader = `
  ...
  void main() {
    ...
    float distort = vDistortion * 0.1 + 0.1;
    color = mix(color, vec3(1.0), distort);
    gl_FragColor = vec4(color, 1.0);
  }
`


export function InteractiveText({ text, position = [0, 0, 0], color = "#ffffff" }) {
  ...
  useFrame((state) => {
    ...
    if (mesh.current) {
      ...
      mesh.current.material.uniforms.uNoiseStrength.value = hovered ? 0.4 : 0.2
    }
  })
