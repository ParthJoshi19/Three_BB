...
const ModelThree = ["/models/airbus.glb", "/models/shiba.glb","/models/blackhole.glb","/models/angel_wings.glb","/models/robo_obj_pose4.glb","/models/sci-fi_vehicle.glb","/models/fool_m416_tongue_motionpubgbgmi.glb","/models/stylized_blade_valorant_style.glb","/models/smoking_gun.glb"];
  ...
  return (
    <div className="bg-transparent rounded-xl p-4 shadow-lg flex flex-col items-center">
      ...
      <div className="flex w-full justify-between items-center mt-4">
        <p className="text-white text-sm mt-2">{shape.split("/")[2].split(".")[0].split("_").join(" ").toUpperCase()}</p>
    ...
    <div className="min-h-screen max-w-screen bg-gradient-to-b from-[#0D1B2A] via-[#0D1B2A] to-[#000] flex flex-col items-center py-10">
      ...
      <div className="pointer-events-none absolute w-full h-screen">
        <Canvas className="absolute w-screen h-screen pointer-events-none">
          ...
          <ParticleSystem count={1000} color={"#FFFFFF"} size={0.15} speed={0.0005} />
        </Canvas>
      </div>
